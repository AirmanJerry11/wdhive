      ...
      <defs>
        ...
        >
          ...
          <feColorMatrix
            ...
            result="hardAlpha"
          ></feColorMatrix>
          <feOffset dy="4.38364"></feOffset>
          <feGaussianBlur stdDeviation="2.19182"></feGaussianBlur>
        ...
        >
          <stop stop-color="var(--colors-scale11)" stop-opacity="0.5"></stop>
          <stop
            offset="1"
            stop-color="var(--colors-scale10)"
            stop-opacity="0"
          ></stop>
        </radialGradient>
        <linearGradient
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stop-color="var(--colors-scale10)" stop-opacity="0"></stop>
          <stop
            offset="0.489583"
            stop-color="var(--colors-scale11)"
            stop-opacity="0.5"
          ></stop>
          <stop
            offset="1"
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stop-color="var(--colors-scale10)" stop-opacity="0.1"></stop>
          <stop
            offset="0.505208"
            stop-color="var(--colors-scale11)"
            stop-opacity="0.5"
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stop-color="var(--colors-scale11)" stop-opacity="0.3"></stop>
          <stop
            offset="1"
            stop-color="var(--colors-scale10)"
            stop-opacity="0"
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stop-color="var(--colors-scale10)" stop-opacity="0.5"></stop>
          <stop
            offset="0.505208"
            stop-color="var(--colors-scale11)"
            stop-opacity="0.5"
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stop-color="#868585"></stop>
          <stop offset="0.208333" stop-color="#838383"></stop>
